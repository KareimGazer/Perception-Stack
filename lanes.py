...
def find_lane_pixels(binary_warped, nwindows=9, margin=100, minpix = 50):
    ...
    nonzero = binary_warped.nonzero() # returns 2 arrays one for x and one for y
...
def draw_path(binary_warped, left_fitx, right_fitx, ploty, matrix_inv, undist):
    ...
    newwarp = cv2.warpPerspective(color_warp, matrix_inv, (undist.shape[1], undist.shape[0])) 
